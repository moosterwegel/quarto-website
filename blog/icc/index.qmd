...
viewof simulation = {
  ...
  iccDiv.append("div").attr("class", "metric-label").text("ICC");
  ...
  function update() {
    ...
    svgA.selectAll("circle.p1").data(data).join("circle").attr("cx", (d, i) => xA(i)).attr("cy", d => yA(d.y1)).attr("r", 4).attr("fill", colorLightBlue).attr("stroke", colorDotStroke).attr("stroke-width", 1);
    svgA.selectAll("circle.p2").data(data).join("circle").attr("cx", (d, i) => xA(i)).attr("cy", d => yA(d.y2)).attr("r", 4).attr("fill", colorLightBlue).attr("stroke", colorDotStroke).attr("stroke-width", 1);
    ...
    svgB.selectAll("circle.scatter").data(data).join("circle").attr("cx", d => scaleB(d.y1)).attr("cy", d => scaleBy(d.y2)).attr("r", 4).attr("fill", colorLightBlue).attr("stroke", colorDotStroke).attr("stroke-width", 1).attr("opacity", 0.9);
    ...
    // Theoretical True Relationship (Beta = 1) passing through the mean
    // Styled distinctively as a Solid Green Line
    svgC.append("line")
      .attr("x1", scaleCx(-maxVal)).attr("y1", scaleCy(meanY1 + 1 * (-maxVal - meanY1)))
      .attr("x2", scaleCx(maxVal)).attr("y2", scaleCy(meanY1 + 1 * (maxVal - meanY1)))
      .attr("stroke", colorOkabeGreen).attr("stroke-width", 2.5);

    // Flattened Observed Relationship (Beta = ICC, for k=1) passing through the mean
    // Styled distinctively as a Dashed Orange Line
    svgC.append("line")
      .attr("x1", scaleCx(-maxVal)).attr("y1", scaleCy(meanY1 + icc * (-maxVal - meanY1)))
      .attr("x2", scaleCx(maxVal)).attr("y2", scaleCy(meanY1 + icc * (maxVal - meanY1)))
    ...
    legendC.append("rect")
      .attr("x", -5).attr("y", -5).attr("width", 175).attr("height", 44)
      .attr("fill", "rgba(255, 255, 255, 0.9)").attr("stroke", "#dee2e6").attr("rx", 4);
    ...
    legendC.append("text").attr("x", 35).attr("y", 12).attr("font-size", "11px").attr("fill", colorAxisText).attr("font-weight", "600").text(`True Effect (\u03B2 = 1.00)`);
    ...
    legendC.append("text").attr("x", 35).attr("y", 30).attr("font-size", "11px").attr("fill", colorAxisText).attr("font-weight", "600").text(`Observed Effect (\u03B2 = ${icc.toFixed(2)})`);
    ...
    svgD.selectAll("circle.k-pt").data(kData).join("circle")
      ...
      .attr("stroke", colorDotStroke).attr("stroke-width", 1);
